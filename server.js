...
app.post('/addCouncil', (req, res) => {
  console.log('Path: /addCouncil');
  if(req.payload.user !== 'admin') {
    res.sendStatus(401);
  } else if (req.body && req.body.name && req.body.password) {
    console.log(req.body);
    req.body.password = bcrypt.hashSync(req.body.password.toUpperCase(), 3);
    db.none('INSERT INTO councils(name, password) VALUES($1, $2)', [req.body.name, req.body.password])
      .then(data => {
        res.sendStatus(200);
      })
      .catch(err => {
